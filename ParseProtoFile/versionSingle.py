...
# 指定源目录和目标目录
source_dir = "/Users/kyrieliao/AndroidStudioProjects/api_proto/src/mobile_framework/jni2proto"
target_dir = "/Users/kyrieliao/python_script/protogeneratedproduclog9"

error_log_file = "/Users/kyrieliao/python_script/error_log9.txt"  # 指定错误日志文件的路径
...
for root, _, files in os.walk(source_dir):
    for file in files:
        if file.endswith(".proto"):
            ...
            pbjs_cmd = f'pbjs -t static-module -w es6 -o {js_output_file} {" ".join(related_proto_files)}'
